...
foreach($questions as $question){
    ...
    public function getData(){
      ...
      public function loadDashboard(){
        ...
        return view('jonny.dashboard',['sectors'=>$sectors,"globalAverage"=>$globalAverage,"addisAbabaStatus"=>$status,'subcities'=>$this->subcitySummary()]);
        }
...
public function getSectorDetail($type,$area_id = false,$sector_id){
    ...
    return view('jonny.sector-detail',compact('sector'));
}
