...
var MODULE_CONFIG = {
		chat: [$("#masterUrl").val()+"libs/list.js/dist/list.js", $("#masterUrl").val()+"libs/notie/dist/notie.min.js", $("#masterUrl").val()+"assets/js/plugins/notie.js", $("#masterUrl").val()+"assets/js/app/chat.js"],
		mail: [$("#masterUrl").val()+"libs/list.js/dist/list.js", $("#masterUrl").val()+"libs/notie/dist/notie.min.js", $("#masterUrl").val()+"assets/js/plugins/notie.js", $("#masterUrl").val()+"assets/js/app/mail.js"],
		user: [$("#masterUrl").val()+"libs/list.js/dist/list.js", $("#masterUrl").val()+"libs/notie/dist/notie.min.js", $("#masterUrl").val()+"assets/js/plugins/notie.js", $("#masterUrl").val()+"assets/js/app/user.js"],
		search: [$("#masterUrl").val()+"libs/list.js/dist/list.js", $("#masterUrl").val()+"assets/js/app/search.js"],
		invoice: [$("#masterUrl").val()+"libs/list.js/dist/list.js", $("#masterUrl").val()+"libs/notie/dist/notie.min.js", $("#masterUrl").val()+"assets/js/app/invoice.js"],
		musicapp: [$("#masterUrl").val()+"libs/list.js/dist/list.js", $("#masterUrl").val()+"assets/js/plugins/musicapp.js"],
		fullscreen: [$("#masterUrl").val()+"libs/jquery-fullscreen-plugin/jquery.fullscreen-min.js", $("#masterUrl").val()+"assets/js/plugins/fullscreen.js"],
		jscroll: [$("#masterUrl").val()+"libs/jscroll/dist/jquery.jscroll.min.js"],
		countTo: [$("#masterUrl").val()+"libs/jquery-countto/jquery.countTo.js"],
		stick_in_parent: [$("#masterUrl").val()+"libs/sticky-kit/dist/sticky-kit.min.js"],
		stellar: [$("#masterUrl").val()+"libs/jquery.stellar/jquery.stellar.min.js", $("#masterUrl").val()+"assets/js/plugins/stellar.js"],
		masonry: [$("#masterUrl").val()+"libs/masonry-layout/dist/masonry.pkgd.min.js"],
		slick: [$("#masterUrl").val()+"libs/slick-carousel/slick/slick.css", $("#masterUrl").val()+"libs/slick-carousel/slick/slick-theme.css", $("#masterUrl").val()+"libs/slick-carousel/slick/slick.min.js"],
		sort: [$("#masterUrl").val()+"libs/html5sortable/dist/html.sortable.min.js", $("#masterUrl").val()+"assets/js/plugins/sort.js"],
		apexcharts: [$("#masterUrl").val()+"libs/apexcharts/dist/apexcharts.min.js", $("#masterUrl").val()+"assets/js/plugins/apexcharts.js"],
		chartjs: [$("#masterUrl").val()+"libs/moment/min/moment-with-locales.min.js", $("#masterUrl").val()+"libs/chart.js/dist/Chart.min.js", $("#masterUrl").val()+"libs/chart.js/dist/chart.ext.js", $("#masterUrl").val()+"assets/js/plugins/chartjs.js"],
		chartist: [$("#masterUrl").val()+"libs/chartist/dist/chartist.min.css", $("#masterUrl").val()+"libs/chartist/dist/chartist.min.js", $("#masterUrl").val()+"libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js", $("#masterUrl").val()+"libs/chartist/dist/chartist.ext.js", $("#masterUrl").val()+"assets/js/plugins/chartist.js"],
		dataTable: [$("#masterUrl").val()+"libs/datatables/media/js/jquery.dataTables.min.js", $("#masterUrl").val()+"libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js", $("#masterUrl").val()+"libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css", $("#masterUrl").val()+"assets/js/plugins/datatable.js"],
		bootstrapTable: [$("#masterUrl").val()+"libs/bootstrap-table/dist/bootstrap-table.min.js", $("#masterUrl").val()+"libs/bootstrap-table/dist/extensions/export/bootstrap-table-export.min.js", $("#masterUrl").val()+"libs/bootstrap-table/dist/extensions/mobile/bootstrap-table-mobile.min.js", $("#masterUrl").val()+"assets/js/plugins/tableExport.min.js", $("#masterUrl").val()+"assets/js/plugins/bootstrap-table.js"],
		bootstrapWizard: [$("#masterUrl").val()+"libs/twitter-bootstrap-wizard/jquery.bootstrap.wizard.min.js"],
		dropzone: [$("#masterUrl").val()+"libs/dropzone/dist/min/dropzone.min.js", $("#masterUrl").val()+"libs/dropzone/dist/min/dropzone.min.css"],
		typeahead: [$("#masterUrl").val()+"libs/typeahead.js/dist/typeahead.bundle.min.js", $("#masterUrl").val()+"assets/js/plugins/typeahead.js"],
		datepicker: [$("#masterUrl").val()+"libs/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js", $("#masterUrl").val()+"libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css"],
		daterangepicker: [$("#masterUrl").val()+"libs/daterangepicker/daterangepicker.css", $("#masterUrl").val()+"libs/moment/min/moment-with-locales.min.js", $("#masterUrl").val()+"libs/daterangepicker/daterangepicker.js"],
		fullCalendar: [$("#masterUrl").val()+"libs/moment/min/moment-with-locales.min.js", $("#masterUrl").val()+"libs/fullcalendar/dist/fullcalendar.min.js", $("#masterUrl").val()+"libs/fullcalendar/dist/fullcalendar.min.css", $("#masterUrl").val()+"libs/notie/dist/notie.min.js", $("#masterUrl").val()+"assets/js/plugins/notie.js", $("#masterUrl").val()+"assets/js/app/calendar.js"],
		parsley: [$("#masterUrl").val()+"libs/parsleyjs/dist/parsley.min.js"],
		select2: [$("#masterUrl").val()+"libs/select2/dist/css/select2.min.css", $("#masterUrl").val()+"libs/select2/dist/js/select2.min.js", $("#masterUrl").val()+"assets/js/plugins/select2.js"],
		summernote: [$("#masterUrl").val()+"libs/summernote/dist/summernote.css", $("#masterUrl").val()+"libs/summernote/dist/summernote-bs4.css", $("#masterUrl").val()+"libs/summernote/dist/summernote.min.js", $("#masterUrl").val()+"libs/summernote/dist/summernote-bs4.min.js"],
		vectorMap: [$("#masterUrl").val()+"libs/jqvmap/dist/jqvmap.min.css", $("#masterUrl").val()+"libs/jqvmap/dist/jquery.vmap.js", $("#masterUrl").val()+"libs/jqvmap/dist/maps/jquery.vmap.world.js", $("#masterUrl").val()+"libs/jqvmap/dist/maps/jquery.vmap.usa.js", $("#masterUrl").val()+"libs/jqvmap/dist/maps/jquery.vmap.france.js", $("#masterUrl").val()+"assets/js/plugins/jqvmap.js"],
		plyr: [$("#masterUrl").val()+"libs/plyrist/src/plyrist.css", $("#masterUrl").val()+"libs/plyr/dist/plyr.polyfilled.min.js", $("#masterUrl").val()+"libs/wavesurfer.js/dist/wavesurfer.min.js", $("#masterUrl").val()+"libs/plyrist/src/plyrist.js", $("#masterUrl").val()+"assets/js/plugins/plyr.js"]
	},
